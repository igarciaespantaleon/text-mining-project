...
nuclei. While the words related to Jesus speak of what he teaches or
gives (love, save, etc.), those related to god are more varied in style.
Likewise, the relationship with God is something especially discussed in
his work. In his own album “Yeezus” he compares himself to the son of
God on earth. In addition, in more recent works that have not been
analyzed in this work we observe how the artist has moved towards a
stage of constant search for God through his songs. In the same way, we
do observe some unions of terms that make us understand that the use of
religiosity can sometimes border on the profane in his lyrics, when
relating terms of nighlife with God.
...
The node “money” clearly stands out as the most connected, with a high
degree of closeness centrality, which indicates that it serves as a
direct bridge to multiple concepts associated with wealth. Around it
gravitate terms such as “rich”, ‘cash’ and “gold”, which form a primary
core of material exaltation.
...
“power” are linked to “wealth” and ‘nobility’ and “cost”, suggesting
reflections on how money is power for the artist. Likewise, terms that
allude to the economic “game” emerge - “buy” ‘pay’ or “play”- which
introduces a dimension of risk and strategy in the narrative. Overall,
this network shows that the theme of money in Kanye West is not merely
decorative: It works in a direct way to narrate everything that money
can give you both on a more mundane level and from the perspective of
power.
...
Digger” in which she talks about how a woman tries to get money from her
...
evolving artistic direction. Employing techniques such as topic modeling
(LDA, NMF) or phrase embeddings could further illuminate latent thematic
structures not immediately evident through traditional frequency
analysis.
...
prior to frequency and TF-IDF analysis would significantly improve our
lexical precision, ensuring that morphological variations are grouped
appropriately and thus reflecting a more accurate portrayal of Kanye’s
lyrical richness.

Thirdly, our sentiment analysis relied heavily on lexicons such as Bing,
NRC, and AFINN, which have inherent limitations when analyzing lyrics
rich in irony, double meanings, and specifically hip-hop slang. To
address these nuances more effectively, future studies should integrate
other advanced contextual language models like BERT or RoBERTa, capable
of capturing deeper semantic and emotional subtleties. Moreover,
...
should ensures that our conclusions go beyond statistical descriptions,
...
critical dimensions of artistic expression. In our case it has revealed
Kanye West's introspective depth, tensions between spirituality and
skepticism, and his aspirations. However, it also highlights significant
opportunities for methodological upgrades. By integrating systematic
lemmatization, advanced language models, corpus expansion, and
qualitative methods, future studies can transform descriptive analyses
into powerful predictive tools, capable of anticipating cultural
impacts, genre evolutions, and linguistic trends across broader musical
and social contexts.

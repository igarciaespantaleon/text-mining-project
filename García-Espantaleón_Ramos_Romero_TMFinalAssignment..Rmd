...
In Kanye West's work, his relationship with himself or how he perceives himself in front of others is something easily recognizable. Through songs like “I Am A God” we see a declaration of intentions in this regard. We observe that the term “I” plays a major role in the lyrical elaboration of the artist, finding numerous terms related to the nighlife (fuck, money, gold, etc.). On the other hand, there is also a strong relationship with God, which can be seen in the union of terms such as “pray” or “god”. It is also interesting to note the relational triangle that we find between “I”, “Me” and “My”, as there is a high relationship between these terms. Those terms are positioned as the most central vertices, indicating that Kanye focuses much of his lyric on the exploration of the self. Around him, thematic clusters emerge where words such as “feel”, “know”, “want” and ‘love’ appear, pointing to the different nuances of his introspection.
...
The “Religion Network” shows that ‘God’ and “Jesus” act as authentic centers of gravity in the graph, with a high degree of betweenness, which means that these terms serve as a link between different semantic nuclei. While the words related to Jesus speak of what he teaches or gives (love, save, etc.), those related to god are more varied in style. Likewise, the relationship with God is something especially discussed in his work. In his own album “Yeezus” he compares himself to the son of God on earth. In addition, in more recent works that have not been analyzed in this work we observe how the artist has moved towards a stage of constant search for God through his songs. In the same way, we do observe some unions of terms that make us understand that the use of religiosity can sometimes border on the profane in his lyrics, when relating terms of nighlife with God.
...
The node “money” clearly stands out as the most connected, with a high degree of closeness centrality, which indicates that it serves as a direct bridge to multiple concepts associated with wealth. Around it gravitate terms such as “rich”, ‘cash’ and “gold”, which form a primary core of material exaltation.

Interconnected with this main group, thematic clusters appear that combine ostentation with social criticism: for example, nodes such as “power” are linked to  “wealth” and ‘nobility’ and “cost”, suggesting reflections on how money is power for the artist. Likewise, terms that allude to the economic “game” emerge - “buy” ‘pay’ or “play”- which introduces a dimension of risk and strategy in the narrative. Overall, this network shows that the theme of money in Kanye West is not merely decorative: It works in a direct way to narrate everything that money can give you both on a more mundane level and from the perspective of power. 

On the other hand, we see relationships at the money level that are circumscribed to specific songs, as for example with the song “Gold Digger” in which she talks about how a woman tries to get money from her lovers for aesthetic operations, luxuries, etc. This explains certain relationships that we see in the center of the “money” node.

# Final Considerations

Throughout this project, we used text mining techniques to explore Kanye West's lyrics beyond just counting words, diving into themes like identity, spirituality, and ambition. We analyzed almost a hundred of his songs to spot frequently used words and examine how they connect, uncovering deeper stories about who he is, what he believes in, and what drives him.

Despite these achievements, our study encountered several methodological challenges worth noting. Firstly, the corpus was limited to Kanye's solo albums, excluding collaborations, promotional singles, and recent works after 2018. Including these additional texts in future research would enhance the temporal breadth and stylistic understanding of Kanye’s evolving artistic direction. Employing techniques such as topic modeling (LDA, NMF) or phrase embeddings could further illuminate latent thematic structures not immediately evident through traditional frequency analysis.

Secondly, inconsistencies in lemmatization during the text processing phase sometimes resulted in artificially fragmented terms (e.g., "run" vs. "running" vs. "ran"). Applying consistent lemmatization or stemming prior to frequency and TF-IDF analysis would significantly improve our lexical precision, ensuring that morphological variations are grouped appropriately and thus reflecting a more accurate portrayal of Kanye’s lyrical richness.

Thirdly, our sentiment analysis relied heavily on lexicons such as Bing, NRC, and AFINN, which have inherent limitations when analyzing lyrics rich in irony, double meanings, and specifically hip-hop slang. To address these nuances more effectively, future studies should integrate other advanced contextual language models like BERT or RoBERTa, capable of capturing deeper semantic and emotional subtleties.
Moreover, complementing our quantitative insights with qualitative analysis (such as reviews, interviews, audience reception, and visual content) would ground our findings in a richer socio-cultural context. This scope should ensures that our conclusions go beyond statistical descriptions, allowing a deeper understanding of how Kanye’s lyrics resonate emotionally and culturally with diverse audiences over time.

In conclusion, this project demonstrates how text mining can illuminate critical dimensions of artistic expression. In our case it has revealed Kanye West's introspective depth, tensions between spirituality and skepticism, and his aspirations. However, it also highlights significant opportunities for methodological upgrades. By integrating systematic lemmatization, advanced language models, corpus expansion, and qualitative methods, future studies can transform descriptive analyses into powerful predictive tools, capable of anticipating cultural impacts, genre evolutions, and linguistic trends across broader musical and social contexts.
